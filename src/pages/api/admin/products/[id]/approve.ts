...
import { approveProduct } from '@/lib/admin/products';
import { requireAdminApiUser } from '@/lib/admin/api-auth';
import { productReviewSchema } from '@/lib/product/validation';
...
export const POST: APIRoute = async (context) => {
	...
	const result = await approveProduct(productId, authResult.userId, parsed.data);
	if (!result.ok) {
